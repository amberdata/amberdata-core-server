...
public class NodesApiController implements NodesApi {
    ...
    public ResponseEntity<Void> nodesIdComingSoonGet(@ApiParam(value = "The node id",required=true) @PathVariable("id") String id) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<Void>(HttpStatus.NOT_IMPLEMENTED);
    }

    public ResponseEntity<Void> nodesIdComingSoonPatch(@ApiParam(value = "The node id",required=true) @PathVariable("id") String id,@ApiParam(value = "Specify some node object data"  )  @Valid @RequestBody Node1 node) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<Void>(HttpStatus.NOT_IMPLEMENTED);
    }
