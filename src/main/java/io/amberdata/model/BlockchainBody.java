...
public class BlockchainBody   {
  ...
  public BlockchainBody blockchainId(String blockchainId) {
  ...
  **/
  ...
  public BlockchainBody slug(String slug) {
    this.slug = slug;
    return this;
  }
  ...
  **/
  ...
  public BlockchainBody name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public BlockchainBody network(String network) {
  ...
  **/
  ...
  public BlockchainBody type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public BlockchainBody permissions(String permissions) {
  ...
  **/
  ...
  public BlockchainBody config(BlockchainsConfig config) {
    this.config = config;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BlockchainBody blockchainBody = (BlockchainBody) o;
    return Objects.equals(this.blockchainId, blockchainBody.blockchainId) &&
        Objects.equals(this.slug, blockchainBody.slug) &&
        Objects.equals(this.name, blockchainBody.name) &&
        Objects.equals(this.network, blockchainBody.network) &&
        Objects.equals(this.type, blockchainBody.type) &&
        Objects.equals(this.permissions, blockchainBody.permissions) &&
        Objects.equals(this.config, blockchainBody.config);
  }
  ...
  public String toString() {
    ...
    sb.append("class BlockchainBody {\n");
