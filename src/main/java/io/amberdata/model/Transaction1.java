...
public class Transaction1   {
  ...
  public Transaction1 hash(String hash) {
    this.hash = hash;
    return this;
  }
  ...
  **/
  ...
  public Transaction1 blockNumber(BigDecimal blockNumber) {
  ...
  **/
  ...
  public Transaction1 contractAddress(String contractAddress) {
  ...
  **/
  ...
  public Transaction1 cumulativeGasUsed(BigDecimal cumulativeGasUsed) {
  ...
  **/
  ...
  public Transaction1 from(String from) {
    this.from = from;
    return this;
  }
  ...
  **/
  ...
  public Transaction1 fee(BigDecimal fee) {
    this.fee = fee;
    return this;
  }
  ...
  **/
  ...
  public Transaction1 gasPrice(BigDecimal gasPrice) {
  ...
  **/
  ...
  public Transaction1 gasLimit(BigDecimal gasLimit) {
  ...
  **/
  ...
  public Transaction1 gasUsed(BigDecimal gasUsed) {
  ...
  **/
  ...
  public Transaction1 transactionIndex(BigDecimal transactionIndex) {
  ...
  **/
  ...
  public Transaction1 input(String input) {
    this.input = input;
    return this;
  }
  ...
  **/
  ...
  public Transaction1 nonce(BigDecimal nonce) {
    this.nonce = nonce;
    return this;
  }
  ...
  **/
  ...
  public Transaction1 status(BigDecimal status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public Transaction1 timestamp(String timestamp) {
  ...
  **/
  ...
  public Transaction1 to(String to) {
    this.to = to;
    return this;
  }
  ...
  **/
  ...
  public Transaction1 value(BigDecimal value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public Transaction1 meta(String meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Transaction1 transaction1 = (Transaction1) o;
    return Objects.equals(this.hash, transaction1.hash) &&
        Objects.equals(this.blockNumber, transaction1.blockNumber) &&
        Objects.equals(this.contractAddress, transaction1.contractAddress) &&
        Objects.equals(this.cumulativeGasUsed, transaction1.cumulativeGasUsed) &&
        Objects.equals(this.from, transaction1.from) &&
        Objects.equals(this.fee, transaction1.fee) &&
        Objects.equals(this.gasPrice, transaction1.gasPrice) &&
        Objects.equals(this.gasLimit, transaction1.gasLimit) &&
        Objects.equals(this.gasUsed, transaction1.gasUsed) &&
        Objects.equals(this.transactionIndex, transaction1.transactionIndex) &&
        Objects.equals(this.input, transaction1.input) &&
        Objects.equals(this.nonce, transaction1.nonce) &&
        Objects.equals(this.status, transaction1.status) &&
        Objects.equals(this.timestamp, transaction1.timestamp) &&
        Objects.equals(this.to, transaction1.to) &&
        Objects.equals(this.value, transaction1.value) &&
        Objects.equals(this.meta, transaction1.meta);
  }
